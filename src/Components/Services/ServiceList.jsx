...
export var newServices = [
  {
    id: 1,
    image: "TOWNHOME, MANUFACTURED HOME, DUPLEX, MULTIPLEX INSPECTION",
  ...
  {
    id: 5,
    image: "LIGHT COMMERCIAL INSPECTION",
  ...
  {
    id: 6,
    image: "WOOD DESTROYING ORGANISMS / INSECTS (WDO/WDI) INSPECTION",
